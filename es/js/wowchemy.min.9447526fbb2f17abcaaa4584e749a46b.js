...
See: https://github.com/francoischalifour/medium-zoom`);
    ...
    var o = { authors: "Autores", event: "Eventos", post: "Posts", project: "Proyectos", publication: "Publicaciones", slides: "Diapositivas" }, i = { no_results: "No se encontraron resultados", placeholder: "Buscar...", results: "resultados encontrados" }, t = { indexURI: "/es/index.json", minLength: 1, threshold: 0.3 }, n = { shouldSort: true, includeMatches: true, tokenize: true, threshold: t.threshold, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: t.minLength, keys: [{ name: "title", weight: 0.99 }, { name: "summary", weight: 0.6 }, { name: "authors", weight: 0.5 }, { name: "content", weight: 0.2 }, { name: "tags", weight: 0.5 }, { name: "categories", weight: 0.5 }] }, e = 60;
    function a(e2) {
